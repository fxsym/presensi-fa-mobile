...
class _MembersScreenState extends State<MembersScreen> {
  ...
  Future<void> fetchMembers() async {
    ...
    try {
      ...
      final List<dynamic> usersJson = response['users']; // asumsi responsenya seperti: { "data": [user1, user2, ...] }
                  ...
                  children: [
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(member.nim ?? '', style: TextStyle(color: Colors.grey)),
                                          ],
                                        ),
                                      ),
                                      ...
                                      Switch(
                                        ...
                                        onChanged: (_) {
                                          ScaffoldMessenger.of(context).showSnackBar(
                                            SnackBar(
                                              content: Text("Status toggle belum diimplementasi"),
                                            ),
                                          );
                                        },
                                      ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ...List.generate(totalPages, (i) => i + 1).map((page) => TextButton(
